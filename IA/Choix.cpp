...
string Choix::IA()
{
    ...
    {
        if(m_cave->getEscalier().first == manuNous->getSalle()->getPosition().first && m_cave->getEscalier().second && manuNous->getSalle()->getPosition().second)
        {
            ...
            if(m_couleur_nous == couleur_active){
                ...
                if(m_nb_manutentionnaire == 3)
                {
                    ...
                    if(m_nb_manutentionnaire == 3)
                    {
                        ...
                        >>>>>>> df34bace7792158bcd28d91a2ae7c879d656bd9e
                    }
                    // Premier tour de jeu :
                    // - réception des actions du premier manutentionnaire
                    m_tcpGdOrdo->receptionChaine();
